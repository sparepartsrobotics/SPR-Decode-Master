...
public class RedAuto2 extends OpMode {
    ...
    private final Pose launchPose = new Pose(88, 96, Math.toRadians(222));
...
//                setPathState(-1);
    ...
    public void init() {
        ...
        outtake1.setVelocityPIDFCoefficients(25,0,0,19);
        outtake2.setVelocityPIDFCoefficients(25,0,0,19);
    }
